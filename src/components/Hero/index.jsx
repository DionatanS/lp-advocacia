    ...
    <div className={styles.containerHero}>
      ...
      <div className={styles.contentHero}>
        ...
        <div className={styles.cointainerHeroText}>
          <h2 className={styles.subtituloHero}>
            Não aceite benefícios{" "}
            <span className={styles.destaque}>negados</span> ou em{" "}
            <span className={styles.destaque}>análise</span> por tempo
            indefinido!
          </h2>
          ...
          <a
            ...
            className={styles.buttonFaleConosco}
          >
            FALE CONOSCO{" "}
            <Image
              width={30}
